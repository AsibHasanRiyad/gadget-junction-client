    ...
    <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-10">
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                <img className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96" src="https://i.ibb.co/m4fsDdr/Probably-the-best-one-for-the-bl-width-1600-format-webp-1.webp" alt=""/>
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">gadgetjunction@example.com</span>
                    </p>
                </div>
