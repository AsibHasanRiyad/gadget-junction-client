...
const Sam = ({sam}) => {
    const {brandName, name, image, _id, price, rating, type} = sam;
  ...
  const admin = "riadahmedcoc@gmail.com"
    return (
        <div className="transition duration-500 ease-out transform card bg-base-50 dark:shadow-none hover:scale-105">
      <figure>
        <img
          src={image}
          alt="Product"
